...
class Link(Base):
    ...
    criado_por = Column(Integer, ForeignKey("usuarios.id"), nullable=False)
    # Vínculo do link com a atividade da semana. Nullable para não quebrar
    # links antigos que foram criados antes dessa coluna existir.
    ...
    atividade = relationship("Atividade", backref="links")
